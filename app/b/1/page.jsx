...
export default async function a() {
  ...
  let currentQuestionChoice = "/b"
  let questionsChoice = [
    "Q14 Which of the following sources do you use the most to get information about preparing for future wildfires?",
    "Q15 Which of the following would you most likely do to better prepare for wildfires? Choose multiple answers from a list",
  ]
  // default questions
  ...
  return (
    <main className="main">
      ...
      {questionsChoice.map( (q,index)=> <Link className={index === 1 ? "btn btn--active" : "btn"} onClick={currentQuestionChoiceUpdater(index)} href={currentQuestionChoice} >{q}</Link> ) }
      </div>
