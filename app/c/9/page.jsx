...
export default async function a() {
  ...
  return (
    <main className="main">
      ...
      {questionsChoice.map( (q,index)=> <Link key={index}  className={index === 9 ? "btn btn--active" : "btn"} onClick={currentQuestionChoiceUpdater(index)} href={currentQuestionChoice} >{q}</Link> ) }
      </div>
