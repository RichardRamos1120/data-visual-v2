...
{questionsChoice.map( (q,index)=> <Link key={index} className={index === 9 ? "btn-question-item btn btn--active" : "btn btn-question-item"} onClick={currentQuestionChoiceUpdater(index)} href={currentQuestionChoice} >{q}</Link> ) }
</div>
